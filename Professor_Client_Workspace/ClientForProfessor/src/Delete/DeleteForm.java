...
public class DeleteForm extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == deleteButton){
			System.out.println("[회원삭제 화면]삭제 버튼 클릭");
			this.excuteDelete();	//회원 등록 처리
		}
		//취소 버튼
		...
		//학생 선택 콤보박스
			...
			Transit.sendMsg("회원삭제정보가져오기/"+selectedItem);
		}
	} //이벤트 처리기 함수 끝
