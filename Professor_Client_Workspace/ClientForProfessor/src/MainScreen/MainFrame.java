...
public class MainFrame extends JFrame implements ActionListener{
	...
	private JMenuItem releaseMovingImagePopUpMenuItem = null;	//연속 화면 보기 해제
	private JMenuItem remoteControlPopUpMenuItem = null;	//원격 제어
	private JMenuItem releasePopUpMenuItem = null;			//감시 해제
	...
	public void actionPerformed(ActionEvent e){
		...
		//아이피 주소 보여주기 메뉴아이템
			...
			JOptionPane.showMessageDialog(Manager.MAINFRAME, "현재 컴퓨터의 IP 주소 : "+ipAddress, "IP 주소", JOptionPane.WARNING_MESSAGE);
		}
		//프로그램 사용 안내 메뉴아이템
		else if(e.getSource() == guideProgramMenuItem){
			mainCenterTabbedPane.addTab("환영합니다.", Manager.WELCOMEPROGRAM);
		}
		//팝업 메뉴의 스크린 샷 찍기
		...
		//팝업 메뉴의 연속화면 보기 해제
			...
			Transit.sendMsg("연속화면해제요청/" + selectedId);
		}
		//팝업 메뉴의 원격 제어
		...
		//팝업 메뉴의 감시 해제
			...
			Transit.sendMsg("감시해제/" + selectedId); 
		}
	...
	private void createPopUpMenu(){
		...
		releaseMovingImagePopUpMenuItem = new JMenuItem("연속 화면 보기 해제");
		remoteControlPopUpMenuItem = new JMenuItem("감시");
		releasePopUpMenuItem = new JMenuItem("감시해제");
	...
	private void createMenu(){
		...
		guideProgramMenuItem = new JMenuItem("프로그램 안내");
